...
export const EXERCISES = {
  ...
  leg_curl: { id: 'leg_curl', name: 'Curl femoral', category: 'accessory', muscleGroup: 'Isquiosurales', equipment: 'Máquina', repRange: [8, 12], sets: 3, defaultRest: 60, startingLoad: 20, increment: 2.5, notes: 'Aislamiento de isquiosurales, control en la fase excéntrica.' },
  ...
  // db_press_fb y row_fb ya no aparecen en el plan activo (ver PROGRAM_DAYS),
  // pero se mantienen en el catálogo para no romper sesiones ya guardadas que
  // los usan (el antiguo día "Full body").
...
export const PROGRAM_DAYS = [
  { id: 'upper_a', dayIndex: 0, day: 'Lunes', title: 'Torso A · Empuje pesado', exerciseIds: ['bench_press', 'barbell_row', 'face_pull', 'biceps_curl', 'triceps_pushdown'] },
  { id: 'lower_a', dayIndex: 1, day: 'Martes', title: 'Pierna A · Sentadilla pesada', exerciseIds: ['squat', 'rdl', 'leg_curl', 'calf_raise', 'plank'] },
  { id: 'upper_b', dayIndex: 3, day: 'Jueves', title: 'Torso B · Press pesado', exerciseIds: ['ohp_db', 'incline_db_press', 'lat_pulldown', 'arms_superset_fb'] },
